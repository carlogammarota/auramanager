<template>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div class="lg:col-span-2 text-white p-4 rounded">
            <img src="../assets/Ahora-en-Vivo.png" class="bg-white mb-4" alt="Evento Aura" style="max-width: 100%; height: auto;">
            <img src="../assets/Programacion1.jpg" alt="" class="mb-4">

            <video controls crossorigin playsinline style="width: 100%;">
                <source type="application/x-mpegURL" src="https://live.armortemplate.com/stream/hls/playlist.m3u8">
            </video>
