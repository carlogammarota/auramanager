        ...
        <div class="w-1/3 text-center py-8">
							...
							>
								<div class="flex items-start justify-between">
									<div class="flex flex-col">
										...
										<span
											class="text-lg font-semibold p-0 m-0 text-left"
											>$5.000 ARS</span
										>
          ...
          <h3 class="mt-6 text-xl">Ventas</h3>
                    ...
                    <!-- {{ventas.}}tragos -->
                          ...
                          v-for="(venta, index) in ventas" :key="index"
												>
  ...
  mounted() {
	...
	methods: {
		...
		async cargarVenta(data) {
			...
			axios.post(
				"https://api.aura-producciones.com/ventas-all/",
				// "https://api.aura-producciones.com/ventas/",
				this.values,
				{
		...
		traerVentas() {
			axios.get("https://api.aura-producciones.com/ventas-all/",
			// axios.get("https://api.aura-producciones.com/ventas/",
				{
					headers: { Authorization: "Bearer " + this.token },
				}).then((response) => {
    ...
    actualizarValor(index) {
      ...
      this.values.tragos[index].valor =
        this.preciosBebidas[bebidaSeleccionada] * cantidadSeleccionada || 0;
