...
export default {
    ...
    methods: {
        ...
        confirmarconsumicion() {
            ...
            axios.patch('https://api.auraproducciones.lat/entradas/' + this.$route.params.id, {
        ...
        async confirmar() {
            ...
            this.modal = false;
            this.loader = true;
            axios.patch('https://api.auraproducciones.lat/admin/entradas/' + this.$route.params.id, {
        ...
        getEntrada() {
            this.loader = true
            axios.get('https://api.auraproducciones.lat/entradas/' + this.$route.params.id,
                {
                    headers: { 'Authorization': 'Bearer ' + this.token }
                })
                .then(response => {
