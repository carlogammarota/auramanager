        ...
        <div class="min-h-screen bg-gray-100 flex items-center justify-center">
            ...
            <div class="bg-white p-8 rounded shadow-md max-w-md w-full" v-if="!loader">
                ...
                <div v-if="compra.estado == 'aprobado'">
                    ...
                    <h1>GRACIAS POR TU PATROCINIO !</h1>
                    <!-- VOLVER A LA RADIO ROUTER LINK -->
                    <router-link to="/radio" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full mx-2 uppercase">
                        Volver a la radio
                    </router-link>
